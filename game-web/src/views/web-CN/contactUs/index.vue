...
<!--      <el-row>-->
<!--        <el-col :span="24">-->
<!--          <div class="container-banner-title animate__animated animate__bounceInDown">联系我们</div>-->
<!--        </el-col>-->
<!--      </el-row>-->
<!--      <el-row>-->
<!--        <el-col :span="24">-->
<!--          <div class="container-banner-content animate__animated animate__bounceInDown">CONTACT US</div>-->
<!--        </el-col>-->
<!--      </el-row>-->
    </div>
      ...
      <el-row :gutter="90">
        ...
        <el-col :span="12">
          <div class="container-body-left">
            <div class="container-body-left-title">联系我们</div>
            <div class="container-body-left-line"></div>
            <div class="container-body-left-word">
              <el-row>
                <el-col style="width: 80px">地&nbsp;&nbsp;&nbsp;&nbsp;址：&nbsp;</el-col>
                <el-col style="width: 83%;">中国深圳蛇口南海大道深圳外代联合大厦一、八、九楼</el-col>
              </el-row>
              邮　编：518066<br/>
              电　话：+86-755-26688998 / 26880935<br/>
              传　真：+86-755-26692769 / 26689946<br/>
              邮　箱：hq@penavicosz.com.cn<br/>
              网　址：www.penavicosz.com.cn<br/>
            </div>
          </div>
        </el-col>
        <!--联系我们—右边信息反馈-->
        <el-col :span="12">
          <div class="container-body-right">
            <div class="container-body-right-title">信息反馈</div>
            <div class="container-body-right-describe">欢迎您留下问题，我们将尽快解答您的疑问！</div>
            <el-form :model="infoForm" ref="infoForm" :rules="rules" :show-message="true">
              <!--姓名-->
              <el-row>
                <el-col :span="24" class="container-body-right-box">
                  <div class="container-body-right-box-labelName">您的姓名</div>
              ...
              <el-row>
                <el-col :span="24" class="container-body-right-box">
                  <div class="container-body-right-box-labelName">手机号码</div>
              ...
              <el-row>
                <el-col :span="17" class="container-body-right-box">
                  <div class="container-body-right-box-labelName">图片验证码</div>
              ...
              <el-row>
                <el-col :span="24" class="container-body-right-box">
                  <div class="container-body-right-box-labelName">电子邮箱</div>
              ...
              <el-row>
                <el-col :span="24" class="container-body-right-box">
                  <div class="container-body-right-box-labelName">公司名称</div>
              ...
              <div class="container-body-right-selectType">
                <el-form-item prop="business_type">
                  <el-radio-group v-model="infoForm.businessType" class="container-body-right-selectTitle-box">
              ...
              <el-row style="margin-top: 40px">
                <el-col :span="24">
                  <div class="container-body-right-submit">
                    <div class="container-body-right-submit-word" @click="submitClick('infoForm')">立即提交</div>
                  </div>
                </el-col>
              </el-row>
            </el-form>
    ...
    data() {
      ...
      const validateCode = (rule, value, callback) => {
        if (!value) {
          ...
          if (num1 === num2) {
            ...
            return callback(new Error('图片验证码错误'))
          }
        } else {
          return callback()
        }
      ...
      return {
        ...
        rules: {
          ...
          content: [{
            required: true, trigger: 'blur', message: '留言内容不能为空'
          }]
          // selectType: [{
        ...
        this.$refs[formName].validate(valid => {
          if (valid) {
            apiSubmitForm(this.infoForm).then(() => {
              this.$message.success('您的信息反馈已提交，我们会尽快与您联系！')

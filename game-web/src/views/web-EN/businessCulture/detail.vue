...
<!--      <el-row>-->
<!--        <el-col :span="24">-->
<!--          <div class="container-banner-title animate__animated animate__bounceInDown">ACTIVITY DETAILS</div>-->
<!--        </el-col>-->
<!--      </el-row>-->
<!--      <el-row>-->
<!--        <el-col :span="24">-->
<!--          <div class="container-banner-content animate__animated animate__bounceInDown">活动详情</div>-->
<!--        </el-col>-->
<!--      </el-row>-->
    </div>
      ...
      <el-row>
        <el-col :span="16">
          ...
          <el-row :gutter="50">
            ...
            <div v-if="lastFlag===false">
              <el-col :span="12">
                <div class="container-body-news" @click="getLastActivity(lastActivity.id)">
                  <div class="container-body-news-word">Previous</div>
            ...
            <div v-if="lastFlag===true">
              <el-col :span="12">
                <div class="container-body-newsDisabled">
                  <div class="container-body-newsDisabled-word">Previous</div>
                  <div class="container-body-newsDisabled-line"></div>
                  <div class="container-body-newsDisabled-content" v-if="lastFlag===true">The previous article is
                    empty
                  </div>
                </div>
              </el-col>
            ...
            <div v-if="nextFlag===false">
              <el-col :span="12">
                <div class="container-body-news" @click="getNextActivity(nextActivity.id)">
                  <div class="container-body-news-word">Next</div>
                  <div class="container-body-news-line"></div>
            ...
            <div v-if="nextFlag===true">
              <el-col :span="12">
                <div class="container-body-newsDisabled">
                  <div class="container-body-newsDisabled-wordDisabled">Next</div>
                  <div class="container-body-newsDisabled-line"></div>
                  <div class="container-body-newsDisabled-content">The next article is empty</div>
                </div>
              </el-col>
            </div>
          </el-row>
        ...
        <el-col :span="6" style="float: right">
          <div class="container-body-right">
            <div class="container-body-right-word">Other Activities</div>
...
<script>
  ...
  let qrcode = ''
  export default {
    name: 'employee-activity-detail-EN',
    ...
    data() {
      return {
        ...
        wechatQrcodeHelper: 'Click "Discover" in WeChat, scan the QR code to share this article to Moments',
    ...
    methods: {
      ...
      getActivityDetail() {
        ...
        apiGetNews(this.activityId).then((res) => {
          ...
          this.activity.publishDt = this.monthData[parseInt(month)] + ' ' + day + ',' + year

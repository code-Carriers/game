...
<!--      <el-row>-->
<!--        <el-col :span="24">-->
<!--          <div class="container-banner-title animate__animated animate__bounceInDown">NEWS CENTER</div>-->
<!--        </el-col>-->
<!--      </el-row>-->
<!--      <el-row>-->
<!--        <el-col :span="24">-->
<!--          <div class="container-banner-content animate__animated animate__bounceInDown">新闻中心</div>-->
<!--        </el-col>-->
<!--      </el-row>-->
    </div>
    ...
    <div class="container-body">
      ...
      <el-row class="container-body-box">
        <el-col :span="12" :class="selectTitle==='公司新闻'?'container-body-box-title-check':'container-body-box-title'">
          <div :class="selectTitle==='公司新闻'?'aClass1':'aClass2'" @click="handleSelectTitle('公司新闻')">Company News</div>
        </el-col>
<!--        <el-col :span="8" :class="selectTitle==='公司公告'?'container-body-box-title-check':'container-body-box-title'">-->
<!--          <div :class="selectTitle==='公司公告'?'aClass1':'aClass2'" @click="handleSelectTitle('公司公告')">Announcement</div>-->
<!--        </el-col>-->
        <el-col :span="12" :class="selectTitle==='行业动态'?'container-body-box-title-check':'container-body-box-title'">
          <div :class="selectTitle==='行业动态'?'aClass1':'aClass2'" @click="handleSelectTitle('行业动态')">Industry News</div>
        </el-col>
      </el-row>
          ...
          <div class="container-body-content-newsRow1" :loading="listLoading">
            <el-row :gutter="30">
              <div v-for="item in newsRow1">
                <!--跳转到具体新闻详情页面-->
                <router-link
                  :to="'/web-EN/newsDetail?id='+item.id+'&page='+newsCriteria.page+'&size='+newsCriteria.size+'&catalog='+newsCriteria.catalog+'&totalElements='+data.totalElements+'&totalPages='+data.totalPages"
                  target="_blank">
                  <el-col :span="8">
                    <div class="container-body-content-newsRow1-item">
                      ...
                      <img class="container-body-content-newsRow1-item-img"
                           ...
                           alt="" v-else/>
                      <!--新闻标题-->
                      <div class="container-body-content-newsRow1-item-title">{{item.title}}
                      </div>
                      <!--新闻来源-->
...
<!--        &lt;!&ndash;公司公告内容&ndash;&gt;-->
<!--        <div class="container-body-content" v-if="this.noticeFlag===false">-->
...
<!--                <router-link-->
<!--                  :to="'/web-EN/newsDetail?id='+item.id+'&page='+newsCriteria2.page+'&size='+newsCriteria2.size+'&catalog='+newsCriteria2.catalog+'&totalElements='+data2.totalElements+'&totalPages='+data2.totalPages"-->
<!--                  target="_blank">-->
<!--                  <el-col :span="8">-->
<!--                    <div class="container-body-content-newsRow1-item">-->
<!--                      <img class="container-body-content-newsRow1-item-img"-->
...
<!--                           alt="" v-else/>-->
<!--                      &lt;!&ndash;公告标题&ndash;&gt;-->
<!--                      <div class="container-body-content-newsRow1-item-title"><span-->
<!--                        :class="item.hot===true?'container-body-content-newsRow1-item-hotTrue':'container-body-content-newsRow1-item-hotFalse'">Hot</span>{{item.title}}-->
<!--                      </div>-->
<!--                      &lt;!&ndash;公告来源&ndash;&gt;-->
...
<!--                        &lt;!&ndash;公告标题&ndash;&gt;-->
<!--                        <span-->
<!--                          :class="item.topVisible===true?'container-body-content-newsRow2-content-hotTrue':'container-body-content-newsRow2-content-hotFalse'">Hot</span>{{item.title}}-->
<!--                      </div>-->
<!--                      &lt;!&ndash;公告概要&ndash;&gt;-->
<!--                      <div-->
<!--                        :class="hoverIndex===index?'container-body-content-newsRow2-content-wordHover':'container-body-content-newsRow2-content-word'">-->
...
<!--        &lt;!&ndash;分页组件&ndash;&gt;-->
<!--        <div class="container-body-pagination" v-if="this.noticeFlag===false">-->
<!--          <el-pagination-->
<!--            background-->
          ...
          <div class="container-body-content-newsRow1" v-loading="listLoading">
            <el-row :gutter="30">
              <div v-for="item in newsRow1">
                <!--跳转到具体动态详情页面-->
                <router-link
                  :to="'/web-EN/newsDetail?id='+item.id+'&page='+newsCriteria3.page+'&size='+newsCriteria3.size+'&catalog='+newsCriteria3.catalog+'&totalElements='+data3.totalElements+'&totalPages='+data3.totalPages"
                  target="_blank">
                  <el-col :span="8">
                    <div class="container-body-content-newsRow1-item">
                      <img class="container-body-content-newsRow1-item-img"
...
<script>
  ...
  import Header from '@/views/public/header-En/header'
  import Footer from '@/views/public/footer-En/footer'
  import {apiGetNewsList} from '@/api/news'

  export default {
    name: 'news-tendency-En',
    ...
    data() {
      return {
        ...
        notice: false,
        urlTest: '',
        monthData: ['', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'June', 'July', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],//英文月份缩写
        newsPage1: 1,//公司新闻页数
        newsPage2: 1,//公司公告页数
        newsPage3: 1,//行业动态页数
      ...
      getNewsData(data) {
        ...
        apiGetNewsList(data).then((res) => {
          ...
          if(this.newsList.length === 1 && data===this.newsCriteria2) {
            this.urlTest='#/web-En/newsDetail?id='+this.newsList[0].id+'&page='+this.newsCriteria2.page+'&size='+this.newsCriteria2.size+'&catalog='+this.newsCriteria2.catalog+'&totalElements='+this.data2.totalElements+'&totalPages='+this.data2.totalPages
            ...
            //   this.news.publishDt = this.monthData[parseInt(month)] + ' ' + day + ',' + year
            // })
          }else {
            ...
            if (this.newsList.length > 3) {
              for (let j = 3, k = 0; j < this.newsList.length; j++, k++) {
                ...
                this.newsRow2[k].publishDt = this.monthData[parseInt(month)] + ' ' + day + ',' + year
              }
            }
          }
        })

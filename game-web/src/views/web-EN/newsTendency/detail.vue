<template>
  <div class="container">
    ...
    <div class="container-banner">
      <!--      <el-row>-->
      <!--        <el-col :span="24">-->
      <!--          <div class="container-banner-title animate__animated animate__bounceInDown">NEWS DETAILS</div>-->
      <!--        </el-col>-->
      <!--      </el-row>-->
      <!--      <el-row>-->
      <!--        <el-col :span="24">-->
      <!--          <div class="container-banner-content animate__animated animate__bounceInDown">新闻详情</div>-->
      <!--        </el-col>-->
      <!--      </el-row>-->
    </div>
      ...
      <el-row>
        <el-col :span="16">
          ...
          <el-row :gutter="50" v-if="flagtext===false">
            ...
            <div v-if="nextFlag===true">
              <el-col :span="12">
                <div class="container-body-newsDisabled">
                  <div class="container-body-newsDisabled-word">Next</div>
                  <div class="container-body-newsDisabled-line"></div>
        ...
        <el-col :span="6" style="float: right" v-if="flagtext===false">
          <div class="container-body-right">
            <div class="container-body-right-word1">Other News</div>
